                        ...
                        Object.keys(fifthLevelObject).length &&
                          Object.keys(fifthLevelObject).forEach((key6) => {
                            ...
                            if (typeof sixthLevelObject === "string") {
                              obj6.children.push({
                                name: sixthLevelObject,
                                id: rootId++,
                              });
                            } else
                              Object.keys(sixthLevelObject).length &&
                                Object.keys(sixthLevelObject).forEach(
                                  (key7) => {
                                    const obj7 = {
                                      name: key7 + "",
                                      id: rootId++,
                                    ...
                                    const seventhLevelObject =
                                      sixthLevelObject[key7];
                                    if (
                                      typeof seventhLevelObject === "string"
                                    ) {
                                      obj7.children.push({
                                        name: seventhLevelObject,
                                        id: rootId++,
                                      });
                                    } else
                                      seventhLevelObject &&
                                        Object.keys(seventhLevelObject)
                                          .length &&
                                        Object.keys(seventhLevelObject).forEach(
                                          (key8) => {
                                            const obj8 = {
                                              name: key8,
                                              id: rootId++,
